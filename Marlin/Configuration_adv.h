...
#define AXIS_RELATIVE_MODES { false, false, false, false } // Bram 15-2: removed extruder
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 5*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
